...
class StudentHomepage extends React.Component{
  constructor(props) {
    ...
    this.state = {
      ...
      <div id="imagei">.</div>
      <div id="yo"><p>Welcome back, student!</p><p>Get ready to ace your exams with our user-friendly portal.</p><p> Quickly take exams, view upcoming tests, and track your results – all in one place. </p></div>
    </div>),
      menuList:[
      {
